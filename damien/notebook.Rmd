...
Many thanks to some of you to provide the solution using regex. Regex is one of the most difficult thing in R (and in several other languages) but it's also one of the most usefull. To extract the area, it is possible to seach for "Dublin" in the string and to get all the numbers following:
