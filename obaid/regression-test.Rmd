...
```
```{r}
predict_mod<- data.frame(predict_val=predict(mod_fit1), price_diff=df2$price_diff)
...
```
```{r}
predict_mod<- data.frame(predict_val=predict(mod_fit2), price_diff=df3$price_diff)
...
```
```{r}
predict_mod<- data.frame(predict_val=predict(mod_fit3), price_diff=df2$price_diff)
...
```
```{r}
predict_mod<- data.frame(predict_val=predict(mod_fit4), price_diff=df2$price_diff)
